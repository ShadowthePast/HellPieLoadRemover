...
{
	//Patch 4, 9/2/2022 patch, cutscene skip patch. Pointers unchanged
...
init
{
	...
	switch(MD5Hash){
		case "BC5E8A60D5F0369D76848A98F0D9E1E2": version = "v1.1.3.202209011619"; break; //Patch on 9/2/2022
...
isLoading
{
	...
	if (version == "v1.1.3.202208041009" || version == "v1.1.3.202209011619"){
